# regiswitch - Python CLI Application

## SKILLS usage
please always declare skill name whenever you decided to use skills
...
6. **Never skip the `--help` text.** Every command, argument, and option must have a `help=` string. Users will run `<your-tool> --help` before reading any documentation.
...
## Skills Reference
- Git workflow: `.cursorrules/skill-git-workflow.md`
- Testing conventions: `.cursorrules/testing.md`

## Core Commands
- Run tests: `uv run pytest tests`

## Skills Usage
Always declare skill name when using skills from `.cursorrules/`.